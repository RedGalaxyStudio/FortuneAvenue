...
void HouseBuyO::update(sf::Vector2f posicionactuInicial) {
	...
	Cell c5(q.at(5), &TextureHouse[playerGameInfo[IndexTurn1].casasPorJugador[IndexCAsa]], posicionactuInicial); cellQua.push_back(c5);
...
void HouseBuyO::evenViewHouseCVO(const sf::Event& event) {
