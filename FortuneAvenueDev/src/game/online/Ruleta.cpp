...
void Ruleta::draw(sf::RenderWindow& window, float deltaTime, bool giroActivo) {
	...
	if (currentSegment == -1 && pointerAngle >= (numSegments - 1) * segmentAngle) {
		...
		currentSegment = numSegments - 1; // El pointer est� en el �ltimo segmento
	}
...
void Ruleta::loadIconTextures() {
	...
	std::string iconPaths[] = {
		...
		"assets/image/IconRulette/icon4.png", "assets/image/IconRulette/icono55.png", "assets/image/IconRulette/icono666.png", "assets/image/IconRulette/icono7.png"
	};
