...
private:
	...
	std::vector<sf::Vector2f> caminoimpuesto3 = { sf::Vector2f(621 , 677),sf::Vector2f(694 ,582) };
	std::vector<sf::Vector2f> caminocasa3 = { sf::Vector2f(505,586), sf::Vector2f(568,636), sf::Vector2f(694,636) };
